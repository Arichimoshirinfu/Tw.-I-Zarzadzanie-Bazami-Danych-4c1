...
<html lang="pl">
  ...
  <body>
	...
	$sql_uzytkownik = 'SELECT * FROM emp';
	$uzytkownik_query = mysqli_query($id_conn, $sql_uzytkownik);
...
<tbody align="Left">
<form action='update_prac.php' method='post'>

	<tr>
		<td>Edytowany Użytkownik: </td> 
		<td><select name="uzytkownik" id="uzytkownik">

		<?php 
		$uzytkownik_wynik = mysqli_fetch_array($uzytkownik_query);
		$uzyt_id = $uzytkownik_wynik['id'];
		$uzyt_firstname = $uzytkownik_wynik['first_name'];
		$uzyt_lastname = $uzytkownik_wynik['last_name'];
		
		while ($uzytkownik_wynik = mysqli_fetch_array($uzytkownik_query)){
			$uzyt_id = $uzytkownik_wynik['id'];
			$uzyt_firstname = $uzytkownik_wynik['first_name'];
			$uzyt_lastname = $uzytkownik_wynik['last_name'];
		...
		?>
		<option value="<?php printf("%s", "'" . $uzyt_id . "'") ?>"> <?php printf("%s", $uzyt_id . " " . $uzyt_firstname . " " . $uzyt_lastname) ?> </option>
		<?php } ?>
		</select></td>
</tr><br>
